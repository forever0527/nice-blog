...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    class Advection extends ShaderPass {
      declare uniforms: Record<string, any>;
      line!: THREE.LineSegments;

      constructor(simProps: Record<string, any>) {
        super({
          material: {
    ...
    class ExternalForce extends ShaderPass {
      ...
      init(simProps: Record<string, any>) {
        super.init();
      ...
      update() {
        ...
        if (this.options.isViscous) {
          vel = this.viscous.update({
            viscous: this.options.viscous, iterations: this.options.iterations_viscous,
            dt: this.options.dt,
          });
        }
    ...
    mouseForce, resolution, viscous, colors,
